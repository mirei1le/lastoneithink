...
<head>
    ...
    <title>Lipglosses - Shopaholics</title>
...
<header>
        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="lipglosses.php">Lipglosses</a></li>
    ...
    <!--<img src="../IMG/Makeupbanner.jpg" alt="Makeup Banner" class="banner-image">-->
    ...
    <div class="product-container">
        ...
        if (isset($_GET['search'])) {
            ...
            $sql = "SELECT p.* FROM products p
                    ...
                    AND s.subcategory_name = 'Lipglosses'";
            ...
            $sql = "SELECT p.* FROM products p
                    JOIN subcategories s ON p.subcategory_id = s.subcategory_id
                    WHERE s.subcategory_name = 'Lipglosses'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<p class='product-brand'>Makeup</p>";
                ...
                echo "</form>";
                echo "<a href='lipglosses.php?product_id=" . htmlspecialchars($row['product_id']) . "#reviews' class='view-reviews'>View Reviews</a>";
                echo "</div>";
                echo "</div>";
            }
        } else {
            if (isset($_GET['search'])) {
                echo "<p class='no-results'>No lipglosses found matching your search.</p>";
            } else {
                echo "<p>No lipglosses available at the moment.</p>";
            }
        }
        ?>
    </div>
