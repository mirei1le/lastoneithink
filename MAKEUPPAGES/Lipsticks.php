...
<head>
    ...
    <title>Lipsticks - Shopaholics</title>
    ...
    <nav>
        ...
        <ul class="nav-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="Lipsticks.php">Lipsticks</a></li>
    ...
    <div class="product-container">
        ...
        if (isset($_GET['search'])) {
            ...
            $sql = "SELECT p.* FROM products p
                    ...
                    AND s.subcategory_name = 'Lipsticks'";
            ...
            $sql = "SELECT p.* FROM products p
                    JOIN subcategories s ON p.subcategory_id = s.subcategory_id
                    WHERE s.subcategory_name = 'Lipsticks'";
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                echo "</form>";
                echo "<a href='Lipsticks.php?product_id=" . htmlspecialchars($row['product_id']) . "#reviews' class='view-reviews'>View Reviews</a>";
                echo "</div>";
                echo "</div>";
            }
        } else {
            if (isset($_GET['search'])) {
                echo "<p class='no-results'>No lipsticks found matching your search.</p>";
            } else {
                echo "<p>No lipsticks available at the moment.</p>";
            }
        }
        ?>
    </div>
