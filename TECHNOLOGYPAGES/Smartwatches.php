...
<head>
    ...
    <title>Smartwatches - Shopaholics</title>
...
<!-- HEADER & NAVIGATION -->
<header>
    <h3 class="promo"> USE CODE [NEW2025] FOR EXTRA UP TO 15% OFF SMARTWATCHES </h3>
</header>
...
<!--<img src="../IMG/SmartwatchesBanner.jpg" alt="Smartwatches Banner" class="banner-image"-->
...
<div class="product-container">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "</form>";
            echo "<a href='Smartwatches.php?product_id=" . htmlspecialchars($row['product_id']) . "#reviews' class='view-reviews'>View Reviews</a>";
            echo "</div>";
            echo "</div>";
        }
    } else {
        if (isset($_GET['search'])) {
            echo "<p class='no-results'>No smartwatches found matching your search.</p>";
        } else {
            echo "<p>No smartwatches currently available. Check back soon!</p>";
        }
    }
    ?>
</div>
