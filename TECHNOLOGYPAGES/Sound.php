...
<!-- HEADER & NAVIGATION -->
<header>
    <h3 class="promo"> USE CODE [NEW2025] FOR EXTRA UP TO 10% OFF SOUND EQUIPMENT </h3>
</header>
    ...
    <ul class="nav-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a href="Smartwatches.php">Smart Watches</a></li>
                <li><a href="Sound.php">Sound</a></li>
            </ul>
        </li>
        <li class="dropdown">
...
<!--<img src="../IMG/SoundBanner.jpg" alt="Sound Equipment Banner" class="banner-image">-->
...
<div class="product-container">
    ...
    if (isset($_GET['search'])) {
        ...
        $sql = "SELECT * FROM products 
                ...
                AND category_id = 1 
                AND subcategory_id = (SELECT subcategory_id FROM subcategories WHERE subcategory_name = 'Sound')";
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<p class='product-brand'>Technology</p>";
            ...
            echo "</form>";
            echo "<a href='Sound.php?product_id=" . htmlspecialchars($row['product_id']) . "#reviews' class='view-reviews'>View Reviews</a>";
            echo "</div>";
            echo "</div>";
        }
    } else {
        if (isset($_GET['search'])) {
            echo "<p class='no-results'>No sound equipment found matching your search.</p>";
        } else {
            echo "<p>No sound equipment currently available. Check back soon!</p>";
        }
    }
    ?>
</div>
